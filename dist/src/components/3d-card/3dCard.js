...
var _dCard = require("./3dCard.styled");
...
var AnimatedCard = (0, _reactSpring.animated)(_dCard.StyledCard);
...
var Card = function Card(_ref) {
  ...
  var calc = function calc(x, y) {
    return [(-y + ref.current.offsetTop + ref.current.clientHeight / 2) / 20, -(-x + ref.current.offsetLeft + ref.current.clientWidth / 2) / 20, 1.1];
  };
...
//# sourceMappingURL=3dCard.js.map